...
// Scoring and keyword extraction are quick, mechanical calls - Flash is fast and cheap.
const FAST_MODEL = () => process.env.GEMINI_FAST_MODEL || 'gemini-flash-latest';
...
async function generate({ system, parts, search = false, json = false, maxTokens = 4000, model = MODEL() }) {
...
module.exports = { generate, parseJson, FAST_MODEL };
